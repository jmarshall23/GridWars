...
__forceinline void xml_Select(char* msg, int entitynum, int brushnum, qboolean bError) { printf(msg); }
...
__forceinline void xml_Winding(char* msg, vec3_t p[], int numpoints, qboolean die) { printf(msg); }
